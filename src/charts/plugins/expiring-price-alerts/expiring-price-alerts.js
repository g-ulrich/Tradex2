  ...
  draw(t) {
    ...
    t.useBitmapCoordinateSpace((s) => {
      ...
      e.lineWidth = 2, this._data.forEach((r) => {
        ...
        e.fillStyle = r.color, e.strokeStyle = r.color, e.lineDashOffset = 0, e.globalAlpha = r.fade ? 0.5 : 1, e.beginPath(), e.moveTo(r.startX + 4, o), e.lineTo(r.endX - 4, o), e.stroke(), e.beginPath(), e.setLineDash([3, 6]), e.lineCap = "round", e.moveTo(r.startX - 30, o), e.lineTo(s.mediaSize.width, o), e.stroke(), e.setLineDash([]), e.beginPath(), e.arc(r.startX, o, 4, 0, 2 * Math.PI), e.arc(r.endX, o, 4, 0, 2 * Math.PI), e.fill(), e.font = "10px sans-serif";
        const c = e.measureText(r.text);
        e.beginPath(), e.roundRect(r.startX - 30 - 20 - c.width, o - 7, c.width + 20, 14, 4), e.fill(), e.fillStyle = "#FFFFFF", e.fillText(r.text, r.startX - 30 - 15 - c.width, o + 3), e.save(), e.translate(r.startX - 30 - 14, o - 6);
        const l = 12 / S;
  ...
  update() {
    ...
    if (i)
      for (const e of this._source._alerts.values()) {
        ...
        h || (h = 0), o || (o = i.width());
        let c = "#000000", l = _;
        e.parameters.crossingDirection === "up" ? (c = e.crossed ? "#386D2E" : e.expired ? "#30472C" : "#64C750", l = e.crossed ? p : e.expired ? f : _) : e.parameters.crossingDirection === "down" && (c = e.crossed ? "#7C1F3E" : e.expired ? "#4A2D37" : "#C83264", l = e.crossed ? p : e.expired ? f : x), t.push({
          priceY: r,
          startX: h,
          endX: o,
          icon: l,
